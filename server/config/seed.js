...
const REPOS     =[{ challenge: 'baking-pies', description: '1-1-2' }, { challenge: 'authorization', description: '1-1-1' },{ challenge: 'authentication', description: '1-1-1' },{ challenge: 'django', description: '1-1-1' },{ challenge: 'python', description: '1-1-2' },{ challenge: 'sinatra', description: '1-2-1' }, { challenge: 'twitter', description: '1-2-1' },{ challenge: 'ruby', description: '1-1-1' },{ challenge: 'jquery', description: '3-2-3' },{ challenge: 'active-record', description: '2-1-1'} ];;
...
User.find(function(err,data){
  ...
  data.forEach(function(user){
    ...
    REPOS.forEach(function(repo){
      ...
      Activity.create({_user: user._id, cohort: cohort ,repo: repo.challenge, activity_type: _.sample(ACT_TYPES), description: repo.description ,phase: phase, week: week, day: day, })
    })
  });
});
